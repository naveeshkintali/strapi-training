...
export interface ApiCarouselCarousel extends Schema.CollectionType {
  ...
  attributes: {
    Carousel: Attribute.DynamicZone<['carousel.carousel']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiImportantNoticeImportantNotice
  extends Schema.CollectionType {
  collectionName: 'important_notices';
  info: {
    singularName: 'important-notice';
    pluralName: 'important-notices';
  ...
  attributes: {
    Notice: Attribute.DynamicZone<['important-notice.show-notice-message']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::important-notice.important-notice',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiMyWebsiteMyWebsite extends Schema.CollectionType {
  collectionName: 'my_websites';
  info: {
    singularName: 'my-website';
    pluralName: 'my-websites';
  ...
  attributes: {
    Carousel_slider: Attribute.DynamicZone<['carousel.carousel']>;
    ImportantNotice: Attribute.DynamicZone<
      ['important-notice.show-notice-message']
    >;
    QuickLinks: Attribute.DynamicZone<['quick-link.quick-link']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::my-website.my-website',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiQuickLinkQuickLink extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Hex_color_code: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::important-notice.important-notice': ApiImportantNoticeImportantNotice;
      'api::my-website.my-website': ApiMyWebsiteMyWebsite;
